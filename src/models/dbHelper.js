...
export const getAll = (tableName, req, res) => {
...
export const getExclusiveSingle = (tableName, resourceId, resourceLocation, res) => {
...
export const getSingle = (parentTable, childTable, parentResourceId, parentResourceLocation,
...
export const editQuestion = (tableName, id, data, res) => {
...
export const deleteResource = (tableName, resourceId, resourceLocation, res) => {
...
export const postQuestion = (data, res) => {
...
export const postAnswer = (data, res) => {
...
export const editAnswer = (data, resourceId, res) => {
...
export const upVote = (tableName, answerId, res) => {
...
export const downVote = (tableName, answerId, res) => {
  const query = `SELECT * From ${tableName} WHERE answer_id = $1 `;
  const values = [answerId];
...
export const accepter = (tableName, answerId, res) => {
...
export const postReply = (data, res) => {
